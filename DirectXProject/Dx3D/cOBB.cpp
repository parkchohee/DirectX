...
bool cOBB::IsCollision(cOBB * pOBB1, ST_SPHERE * pSphere)
{
//	
//	D3DXVECTOR3 p1, p2, p3, p4;
//
//	// 점 4개
//	p1 = D3DXVECTOR3(-pOBB1->m_fAxisHalfLen[0], -pOBB1->m_fAxisHalfLen[1],  pOBB1->m_fAxisHalfLen[2]);
//	p2 = D3DXVECTOR3(-pOBB1->m_fAxisHalfLen[0], -pOBB1->m_fAxisHalfLen[1], -pOBB1->m_fAxisHalfLen[2]);
//	p3 = D3DXVECTOR3( pOBB1->m_fAxisHalfLen[0], -pOBB1->m_fAxisHalfLen[1], -pOBB1->m_fAxisHalfLen[2]);
//	p4 = D3DXVECTOR3( pOBB1->m_fAxisHalfLen[0], -pOBB1->m_fAxisHalfLen[1],  pOBB1->m_fAxisHalfLen[2]);
//
//
//	D3DXVec3TransformCoord(&p1, &p1, pOBB1->GetWorldTM());
//	D3DXVec3TransformCoord(&p2, &p2, pOBB1->GetWorldTM());
//	D3DXVec3TransformCoord(&p3, &p3, pOBB1->GetWorldTM());
//	D3DXVec3TransformCoord(&p4, &p4, pOBB1->GetWorldTM());
//
//	// 직선 기울기
//	float m1;
//	if (p4.x - p3.x < 0.0001 && p4.x - p3.x > - 0.0001)
//		m1 = 0;
//	else
//		m1 = (p4.z - p3.z) / (p4.x - p3.x);
//
//	float m3;
//	if (p4.z - p3.z < 0.0001 && p4.z - p3.z > -0.0001)
//	{
//		m3 = 0;
//	}
//	else
...
//
//	float m2;
//	if (p4.x - p1.x < 0.0001 && p4.x - p1.x > -0.0001)
//		m2 = 0;
//	else
//		m2 = (p4.z - p1.z) / (p4.x - p1.x);
//
//	float m4;
//	if (p4.z - p1.z < 0.0001 && p4.z - p1.z > -0.0001)
//	{
//		m4 = 0;
//	}
//	else
...
//
//	// 직선의 방정식			
//	float d1 = m3*p1.z - (m1 * p1.x);
//	float d2 = m4*p2.z - (m2 * p2.x);
//	float d3 = m3*p3.z - (m1 * p3.x);
//	float d4 = m4*p4.z - (m2 * p4.x);
//
//	// 점의 위치 계산
//	float result1 = pSphere->vCenter.z - (m1 * pSphere->vCenter.x) - d1;
//	float result2 = pSphere->vCenter.z - (m2 * pSphere->vCenter.x) - d2;
//	float result3 = pSphere->vCenter.z - (m1 * pSphere->vCenter.x) - d3;
//	float result4 = pSphere->vCenter.z - (m2 * pSphere->vCenter.x) - d4;
///*
//	if (result1 < 0.0f && result3 > 0.0f)
//	{
//		return true;
//	}
//*/
