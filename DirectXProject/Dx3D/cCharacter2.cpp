...
void cCharacter2::Setup()
{

}

void cCharacter2::Update(iMap* pMap)
{
	m_pMap = pMap;
...
void cCharacter2::Render()
{

}

D3DXVECTOR3& cCharacter2::GetPosition()
{
	return m_vPosition;
}

void cCharacter2::WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	switch (message)
	{
	case WM_KEYDOWN:
